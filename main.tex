...
\begin{theorem}[{\cite[Proposition V.3.2(iii)]{cherbonnier_theorie_1999}\cite[Theorem 7.4.1]{colmez_fontaines_nodate}\cite[Theorem 6.2]{schneiderCoatesWilesHomomorphisms2016}}\protect\footnotemark]\label{thm:main}
    \footnotetext{\cite[Theorem 6.2]{schneiderCoatesWilesHomomorphisms2016} generalizes this result to the Lubing-Tate setting.}
...
\begin{proof}[Sketch of proof of \Cref{thm:main}]
    ...
    Since $p^{-k}\Tr_{\bbQ_{p,n+k}^{\opn{cycl}}/\bbQ_{p,n}^{\opn{cycl}}}\calO_{\bbQ_{p,n+k}^{\opn{cycl}}}\subset \calO_{\bbQ_{p,n}^{\opn{cycl}}}$, by \Cref{eq:24892} one obtains
