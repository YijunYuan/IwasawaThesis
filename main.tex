...
\begin{theorem}[{\cite[Section I.5, Th\'eor\`eme II.1.3]{cherbonnier_theorie_1999}}]
    \begin{enumerate}
        ...
        \item The map $$\opn{Log}^*_{V^*(1)}\colon y\longmapsto \varprojlim_n h_{n,V}^1(y)$$ is an isomorphism from $\calD(V)^{\psi=1}$ to $H_{\opn{Iw}}(K,V)$.
    \end{enumerate}
\end{theorem}
